...
void setup()
{
  ...
  comm.addCommand("D_SET_FKICK", set_fkick);
  comm.addCommand("D_SET_GRAB", set_grab);
  comm.addCommand("D_SET_SHOOT", set_shoot);
  comm.addCommand("D_SET_TSHOOT", set_tshoot);
  comm.addCommand("D_RUN_ENGINE", run_engine);
  comm.addCommand("D_RUN_CATCH", run_catch); 
  comm.addCommand("D_RUN_KICK", run_kick);
  comm.addCommand("D_RUN_FKICK", run_fkick);
  comm.addCommand("D_RUN_GRAB", run_grab);
